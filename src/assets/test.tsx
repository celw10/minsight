...
export function LiveNlClaims() {
    ...
    useEffect(() => {
        fetch(base + id + action + geom + geomType + spatialRel + returnGeom + returnIdsOnly + 
            returnCountOnly + returnElevZ + returnElevM + returnDistinct + outFmt)
    ...
    //     // define unique fields instance for each field object
    //     fields: [
    //     {
    //         name: "MIRIAD.CLAIMS.OBJECTID",
    //         alias: "OBJECTID",
    //         type: "string" //esriFieldTypeOID 
